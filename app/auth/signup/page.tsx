  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        dispatch(register({ userInfo: userData }) as any);
        ...
        <div className="flex-1 flex items-center justify-center h-screen">
          <div className="w-full max-w-md space-y-8 px-4 bg-white text-gray-600 sm:px-2 cardd">
            ...
            <div className="grid grid-cols-3 gap-x-3">
              ...
              {/* Apple Sign In */}
              <button className="flex items-center  bg-blue justify-center py-2.5 border rounded-lg hover:bg-gray-50 duration-150 active:bg-gray-100">
                <FaApple className="w-5 h-5 text-gray-9 00 bg-blue" />
              </button>
            </div>
